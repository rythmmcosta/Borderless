...
export default async function AdminSessionsPage() {
  ...
  return (
    <div>
      ...
      <Table>
        <THead><Tr><Th>ID</Th><Th>Type</Th><Th>Transport</Th><Th>Status</Th><Th>Started</Th></Tr></THead>
        <TBody>
          {sessions.map((s) => (
            <Tr key={s.id}>
          ...
          {sessions.length === 0 && <Tr><Td colSpan={5} className="text-center text-gray-500 py-8">No active sessions</Td></Tr>}
        </TBody>
      </Table>
    </div>
  )
